import type { BrandIconProps } from './BrandIconProps';

export function BrandIconDrizzle({ className, size = 24, role }: BrandIconProps) {
  return (
    <svg className={className} role={role} width={size} height={size} viewBox="0 0 24 24">
      {role === 'img' && <title>Drizzle</title>}
      <path
