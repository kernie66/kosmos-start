...
export function BrandIconMantine({ className, size = 24, role }: BrandIconProps) {
  return (
    <svg className={className} role={role} width={size} height={size} viewBox="0 0 163 163">
      {role && <title>Mantine</title>}
      <path
        fill="#339AF0"
